...
## Updates
  ...
  - Contributed original functionality prompts / subprompts (e.g. Hastebin pasting, research assistant mode, etc) to https://github.com/f/awesome-chatgpt-prompts/  (https://github.com/f/awesome-chatgpt-prompts/pull/606/commits)
